...
print(resultados)
# En este ejemplo, la clase DatabaseAPI proporciona una API simple para interactuar
# con una base de datos. El método query permite a los desarrolladores ejecutar
# consultas SQL de manera sencilla, sin tener que preocuparse por los detalles de
# la conexión o la ejecución de la consulta.
...
# la respuesta correcta es: array([0, 0, 0, 0, 0])
...
# la respuesta correcta es: array([11, 11, 11, 11, 11])
...
# la respuesta correcta es: np.dot(A,B)